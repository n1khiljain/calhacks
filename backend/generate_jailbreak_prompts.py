...
class SystemPromptAnalyzer:
    ...
    def analyze(self, system_prompt: str) -> List[str]:
        ...
        """
        analysis_prompt = f"""You are a security researcher analyzing an LLM system prompt to identify potential vulnerabilities.
...
1. 5-7 fake User/Assistant dialogue exchanges
